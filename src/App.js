...
export let App = () => {
    ...
    return(
        <div className="theme-light bg-skin-bodybg w-screen min-h-screen h-auto">
            ...
            <div className="max-w-screen-xl flex w-full px-4 sm:px-10 xl:px-0 xl:w-4/5 justify-center gap-8 sm:gap-0 sm:justify-between h-10 sm:items-center mx-auto mt-24 flex-col sm:flex-row">

                <input placeholder="Name a Country" type="text" className="h-full outline-none rounded p-2 px-4" onChange={(e) => setValue(e.target.value)} value={value}/>
